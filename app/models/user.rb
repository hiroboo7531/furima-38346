...
with_options presence: true, format: { with: /\A[ァ-ヴー]+\z/u, message: 'に全角カタカナを使用してください' } do
...
# なお、全角カタカナの文字コードの順番としては、ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポ
